...
from nets import newmethod_common
...
class Mobilenet_SSD_Traffic(object):
    ...
    def bboxes_encode(self, labels, bboxes, anchors,
        ...
        """
        return newmethod_common.tf_ssd_bboxes_encode(
    ...
    def bboxes_decode(self, feat_localizations, anchors,
        ...
        """Encode labels and bounding boxes.
        """
        return newmethod_common.tf_ssd_bboxes_decode(
    ...
    def detected_bboxes(self, predictions, localisations,
        ...
        rscores, rbboxes = \
            newmethod_common.tf_ssd_bboxes_select(predictions, localisations,

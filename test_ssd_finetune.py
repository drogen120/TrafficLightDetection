...
LISA_LABELS = ["None", "Green", "GreenLeft", "None", "Yellow", "YellowLeft", "Red", "RedLeft"]
...
def write_results(img_name, rclasses, rscores, rbboxes):
...
def make_file():
    for i in range(len(LISA_LABELS)):
        filename = "./results/" + LISA_LABELS[rclasses[i]]+ "/results.csv"
